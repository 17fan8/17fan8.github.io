...
var i18n = function () {
    var table = {
        en: {
            title: "Have Dinner With You！",
            subtitle: "Base on nebulas's technology",
            amount: "Amount",
            blog: "Blog",
            ...
            "new/save1": "Save your",
            "new/save3": ".",
            "new-dinner/title":"title",
            "new-dinner/begin-block":"the begin block height",
            "new-dinner/end-block":"the end block height",
            "new-dinner/min-bid-step":"Min Bid Step",
            "new-dinner/max-bid-step":"Max Bid Step",
            "new-dinner/share-percent":"Share Percent",
            "new-dinner/issue":"Issue",
            "new-dinner/lock":"Lock",
            "new-dinner/unlock":"Unlock",
            "new-dinner/hash":"hash",
            "new-dinner/contact-info":"Contact Info",
            "new-dinner/take-nas-by-owner":"Get Dinner Nas",
            "new-dinner/take-nas-by-creator":"Get Contract Nas",
            "placeholder/addr": "fill address here",
            "placeholder/name": "fill receiver's name here",
            "placeholder/title": "fill dinner title here",
            ...
            "placeholder/min-bid-step":"fill the min bid step",
            "placeholder/max-bid-step":"fill the max bid step",
            "placeholder/share-percent":"fill the share percent",
            "placeholder/date": "fill date here",
            "placeholder/hash": "fill hash here",
            "placeholder/contact-info":"fill contact info here",
            "placeholder/nas-to-take":"fill nas to take",
            "placeholder/data":"fill the dinner's data here",
            resources: "Resources",
            ...
            "list/owner-address": "Owner Address",
        ...
        zh: {
            ...
            "new/save1": "保存你的",
            "new/save3": "。",
            "new-dinner/begin-block":"开始区块",
            "new-dinner/end-block":"结束区块",
            "new-dinner/title":"主题",
            "new-dinner/min-bid-step":"最小出价间隔",
            "new-dinner/max-bid-step":"最大出价间隔",
            "new-dinner/share-percent":"分享比例",
            "new-dinner/issue":"发布",
            "new-dinner/lock":"锁定活动",
            "new-dinner/unlock":"解锁活动",
            "new-dinner/hash":"hash",
            "new-dinner/contact-info":"联系信息",
            "new-dinner/take-nas-by-owner":"提取活动NAS",
            "new-dinner/take-nas-by-creator":"提取智能合约NAS",
            "placeholder/addr": "地址",
            ...
            "placeholder/min-bid-step":"填入最小出价间隔",
            "placeholder/max-bid-step":"填入最大出价间隔",
            "placeholder/share-percent":"填入分享比例",
            "placeholder/date": "日期",
            "placeholder/hash": "填入hash",
            "placeholder/contact-info":"填入联系信息这里",
            "placeholder/nas-to-take":"填入要提取的NAS数量",
            "placeholder/data":"填入饭局数据",
            resources: "资源",
            ...
            "list/owner-address": "拥有者地址",
            "list/issuer-address": "颁发者地址",
            ...
            "transfer/code": "认证代码",
            rules:"活动规则：在活动期间进行竞价，每次出价后系统会托管当前的竞价押金，并且自动退还前一出价人的押金，活动结束后出价最高者可赢得和大佬一起吃饭聊天的机会，并根据分成比例奖励给活动的所有参与者（参与者奖励金额=最高押金*分成比例*参与者竞价次数/总竞价次数）。竞拍所得收益扣除常规运维成本外，全部捐献给关爱儿童爱心小屋项目。"
        }
    };
